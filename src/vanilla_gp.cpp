...
namespace erl::gaussian_process {
    ...
    VanillaGaussianProcess::Train(const long num_train_samples) {
        ...
        const auto [rows, cols] = m_kernel_->ComputeKtrain(m_mat_x_train_, m_vec_var_h_, m_num_train_samples_, m_mat_k_train_, m_vec_alpha_);
    ...
    VanillaGaussianProcess::Test(
        ...
        const auto [ktest_rows, ktest_cols] = m_kernel_->GetMinimumKtestSize(m_num_train_samples_, 0, 0, n);
